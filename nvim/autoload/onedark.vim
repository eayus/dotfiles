...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#bd5157", "cterm": "204", "cterm16": "1" }),
      \ "dark_red": get(s:overrides, "dark_red", { "gui": "#993A3E", "cterm": "196", "cterm16": "9" }),
      \ "green": get(s:overrides, "green", { "gui": "#DAA169", "cterm": "114", "cterm16": "2" }),
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#4b616e", "cterm": "39", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#8F8191", "cterm": "170", "cterm16": "5" }),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#56B6C2", "cterm": "38", "cterm16": "6" }),
      \ "white": get(s:overrides, "white", { "gui": "#ABB2BF", "cterm": "145", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#383544", "cterm": "235", "cterm16": "0" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#f06a4f", "cterm": "59", "cterm16": "15" }),
      \}
